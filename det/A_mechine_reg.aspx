                    ...
                    <td>
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="mechine_name" HeaderText="Mechine Name"></asp:BoundColumn>
                                <asp:BoundColumn DataField="brand" HeaderText="Brand"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Partnumber" HeaderText="Part Number"></asp:BoundColumn>
