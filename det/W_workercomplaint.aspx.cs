...
public partial class workercomplaint : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select max(cmp_id)from complaints";
        id = obj.max_id(cmd);
        cmd.CommandText = "insert into complaints values('" + id + "','"+Session["id"]+"','worker','" + TextBox3.Text + "','pending','" + TextBox6.Text + "')";
        obj.execute(cmd);
        TextBox2.Text = "";
        TextBox3.Text = "";
        cmd.CommandText = "select * from complaints where type='Worker' and employee_id= '" + Session["id"] + "'";
